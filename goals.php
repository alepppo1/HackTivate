...
<main>
    <div class="grid two">
        <div class="card">
            <div class="pill" data-en="Step 3 of 4" data-bm="Langkah 3 daripada 4">
                Step 3 of 4
            </div>

            <h2 style="margin-top:14px;" data-en="Life Goals" data-bm="Matlamat Hidup">
                Life Goals
            </h2>

            <p class="muted" data-en="Add non-loan goals like Umrah, study, deposit, or emergency fund." data-bm="Tambah matlamat bukan pinjaman seperti Umrah, belajar, deposit, atau dana kecemasan.">
                Add non-loan goals like Umrah, study, deposit, or emergency fund.
            </p>
            ...
            <form method="POST" class="form">
                ...
                <div style="grid-column:1/-1;display:flex;gap:10px;flex-wrap:wrap;">
                    <button class="btn primary" type="submit" data-en="Add Goal" data-bm="Tambah Matlamat">
                        Add Goal
                    </button>

                    <a class="btn secondary" href="simulator.php?profile_id=<?php echo $profile_id; ?>" data-en="Continue to Simulator" data-bm="Terus ke Simulator">
        ...
        <div class="card">
            <h2 data-en="Goal List" data-bm="Senarai Matlamat">
                Goal List
            </h2>

            <?php if (empty($goals)): ?>
                <p class="muted" data-en="No goal added yet." data-bm="Belum ada matlamat ditambah.">
                    No goal added yet.
                </p>
            <?php endif; ?>
            ...
            <?php foreach ($goals as $g): ?>
                ...
                <div class="item">
                    <div>
                        ...
                        <div class="muted">
                            Target <?php echo money($g['target_amount']); ?> •
                            Saved <?php echo money($g['current_saved']); ?> •
                            <?php echo (int)$g['target_months']; ?> months
                        </div>

                        <div class="muted">
                            <b><?php echo money($monthly); ?>/month</b>
                        </div>
                    </div>
                    ...
                    <div class="item-actions">
                        <form method="POST" style="margin:0;">
                            ...
                            <button class="delete" type="submit" data-en="Delete" data-bm="Padam">
                                Delete
                            </button>
                        </form>
                    </div>
            ...
            <div style="margin-top:18px;">
                <a class="btn primary" href="simulator.php?profile_id=<?php echo $profile_id; ?>" data-en="Continue to Simulator" data-bm="Terus ke Simulator">
                    Continue to Simulator
                </a>
            </div>
        </div>
